 ...
 */
final class Version20260529083440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE runner CHANGE bib_number bib_number INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE runner CHANGE bib_number bib_number INT NOT NULL');
