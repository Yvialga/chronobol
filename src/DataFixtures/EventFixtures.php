...
class EventFixtures extends Fixture
{
    ...
    {
        $events = [
            ["Bol d'air 2026", new \DateTime('21-06-2026'), self::BOL_2026_REFERENCE],
            ["Bol d'air 2027", new \DateTime('21-06-2027'), self::BOL_2027_REFERENCE],
            ["Bol d'air 2028", new \DateTime('21-06-2028'), self::BOL_2028_REFERENCE],
        ];
        foreach ($events as $i) {
            $event = new Event();
            $event->setName($i[0]);
